...
/**
 * Created by Gustavo on 10/03/2016.
 */
public class CarroDB extends SQLiteOpenHelper {

    private static final String TAG = "sql";
    private static final String NOME_BANCO = "livro_android_sqlite";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("create table if not exists carro (_id integer primary key autoincrement, " +
                "nome text, desc text, url_foto text, url_info text, url_video text, " +
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        // Caso mude a versão do banco de dados podemos executar um upgrade aqui
    }
